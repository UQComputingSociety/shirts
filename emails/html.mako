<!-- This entire template is thanks to Rackspace Mailgun. See mailgun/transactional-email-templates on GH. -->
<html>
<head>
    ...
    <td class="container" width="600">
      <div class="content">
          ...
          <tr>
            <td class="content-wrap aligncenter">
              <table width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td class="content-block aligncenter">
                    UQ Computing Society<br  />
                    Level 2 Union Building,<br />
        ...
        <div class="footer">
          <table width="100%">
            <tr>
              <td class="aligncenter content-block">Questions? Email <a href="mailto:contact@uqcs.org.au">contact@uqcs.org.au</a></td>
            </tr>
          </table>
        </div></div>
    </td>
